...
hl(0, "Keyword", { fg = c.cyan, bg = 'NONE', italic=true, })
...
hl(0, "Special", { fg = c.base0D, bg = 'NONE', })
...
hl(0, "@constructor", { fg = c.base0E, bg = 'NONE', })
hl(0, "@variable.parameter", { fg = c.yellow, bg = 'NONE', })
hl(0, "@variable.parameter.builtin", { fg = c.sun, bg = 'NONE', })
hl(0, "@keyword", { fg = c.dark_purple, bg = 'NONE', italic=true, })
hl(0, "@keyword.function", { fg = c.purple, bg = 'NONE', })
...
hl(0, "@markup.raw.markdown_inline", { fg = c.blue, bg = c.one_bg2, })
